...
function make(_in, mountOnEnter, unmountOnExit, appear, enter, exit, timeout, classNames, onEnter, onEntering, onEntered, onExit, onExiting, onExited, children) {
  var tmp = { };
  if (_in !== undefined) {
  ...
  return ReasonReact.wrapJsForReason(Index.CSSTransition, tmp, children);
}
